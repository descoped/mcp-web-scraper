...
import {StructuredLogger} from '@/core/structuredLogger.js';
import {MetricNames, MetricsCollector} from '@/core/metricsCollector.js';
...
export class MonitorManager implements IMonitorManager {
    ...
    getErrorSummary(windowMs: number = 3600000): ErrorSummary {
        ...
        const recentErrors = windowErrors.slice(-10).map(errorEntry => ({
            ...
            errorCode: (errorEntry.error as Error & { code?: string }).code,

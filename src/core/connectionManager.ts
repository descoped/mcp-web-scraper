...
import type {IConnectionManager, IMCPConnection} from '@/types/index.js';
...
export class MCPConnection implements IMCPConnection {
     ...
     */
    async sendNotification(notification: { method: string; params: Record<string, unknown> }): Promise<void> {
        try {
...
export class ConnectionManager implements IConnectionManager {
     ...
     */
    async broadcastNotification(notification: { method: string; params: Record<string, unknown> }): Promise<void> {

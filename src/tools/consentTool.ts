...
import type {ConsentArgs, ConsentResult, ToolContext, ToolResult} from '@/types/index.js';
import {ConsentArgsSchema, DEFAULT_BROWSER_CONTEXT as DefaultContext} from '@/types/index.js';

...
export class PlaywrightMCPServer implements IPlaywrightMCPServer {
   ...
   */
    ...
    /**
     * Get consent patterns for tool contexts
     * @returns ConsentPatterns object with all detection patterns
     */
    getConsentPatterns(): ConsentPatterns {
        return this.consentHandler.getPatterns();
    }
    ...
    async stop(): Promise<void> {
        ...
        try {
            ...
            if (process.env.NODE_ENV !== 'test' && process.env.VITEST !== 'true') {
                ...
                // In test environment, just throw the error
                throw error;
            }
        }
    }
